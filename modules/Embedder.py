...
from utils import test_st2vec as test_method
import time
import random
import numpy as np
    ...
    def ST_eval(self, load_model=None):
        ...
        if load_model != None:
            ...
            with torch.no_grad():
                ...
                test_method.embed_model(embedding_vali, typ='train', isvali=True)
                ...
                embedding_vali = test_method.compute_embedding(road_network=road_network, net=net,
                                                               ...
                                                               test_time=list(vali_d2vec_list),
                                                               test_batch=self.test_batch)
                test_method.embed_model(embedding_vali, typ='valid', isvali=True)
                ...
                embedding_vali = test_method.compute_embedding(road_network=road_network, net=net,
                                                               ...
                                                               test_time=list(vali_d2vec_list),
                                                               test_batch=self.test_batch)
                test_method.embed_model(embedding_vali, typ='test', isvali=True)
                exit()
        ...
        for epoch in range(int(lastepoch), self.epochs):
            ...
            if epoch%2 == 0:
                ...
                with torch.no_grad():
                    ...
                    save_optname = './optimizer/{}/{}_{}_2w_ST/{}_{}_epoch_{}.pkl'.format(self.dataset, self.dataset, self.distance_type, self.dataset,
                                                                                              self.distance_type,
                                                                                              str(epoch))
